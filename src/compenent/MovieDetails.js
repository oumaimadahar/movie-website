...
function MovieDetails({ onClose }) {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center p-4 overflow-auto">
            <div className="bg-white rounded-lg shadow-xl flex flex-col md:flex-row w-full max-w-5xl h-auto overflow-hidden">
                
                {/* Image du film */}
                <div className="w-full md:w-1/3 h-80 md:h-auto flex-shrink-0">
                    <img
